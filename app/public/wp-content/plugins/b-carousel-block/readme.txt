=== B Carousel Block - Responsive slider ===
Contributors: abuhayat, charlescormier
Donate link: https://gum.co/wpdonate/
Tags: block, image carousel, logo carousel, client logo carousel, Gutenberg block
...
A lightweight and fully functional carousel builder plugin for WordPress 

== Description ==

B Carousel is a lightweight and fully functional carousel builder plugin for WordPress that can be used to make sliders/carousel of your client logo or any images in a professional way.


**[Demos](https://bblockswp.com/demo/carousel-block/)**
...
- Add the Carousel block from the block category called "Widgets" in Gutenberg editor.
